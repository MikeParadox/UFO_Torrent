...
- разнообразные функции и модернизации(возможность обрабатывать несколько 
торрент-файлов одновременно, совершенствование алгоритмов разделения
файлов на части и выбора пиров).
